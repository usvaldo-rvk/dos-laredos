...
async function main() {
    ...
    const ubicaciones = [
        { codigo: 'A', tipo: 'FILA', descripcion: 'Fila A' },
        { codigo: 'B', tipo: 'FILA', descripcion: 'Fila B' },
        { codigo: 'C', tipo: 'FILA', descripcion: 'Fila C' },
        { codigo: 'D', tipo: 'FILA', descripcion: 'Fila D' },
        { codigo: 'E', tipo: 'FILA', descripcion: 'Fila E' }
    ];
